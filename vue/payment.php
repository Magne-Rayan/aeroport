		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a class="tag_menu active_tab" href="payment.html">Payment</a>                    </li>
					...
					<div class="payment clearfix">
						...
						<div class="col-sm-7">
								...
								<div class="col-xs-12">
									<div class="table-responsive">
										<table class="table preview-table">
											...
											<tbody><tr><td class="input-concept"></td><td class="input-description"></td><td class="input-amount">NaN</td><td class="input-status">Paid</td><td class="input-date"></td><td class="input-remove-row"><span class="glyphicon glyphicon-remove"></span></td></tr><tr><td class="input-concept"></td><td class="input-description"></td><td class="input-amount">NaN</td><td class="input-status">Paid</td><td class="input-date"></td><td class="input-remove-row"><span class="glyphicon glyphicon-remove"></span></td></tr><tr><td class="input-concept"></td><td class="input-description"></td><td class="input-amount">NaN</td><td class="input-status">Paid</td><td class="input-date"></td><td class="input-remove-row"><span class="glyphicon glyphicon-remove"></span></td></tr><tr><td class="input-concept"></td><td class="input-description"></td><td class="input-amount">NaN</td><td class="input-status">Paid</td><td class="input-date"></td><td class="input-remove-row"><span class="glyphicon glyphicon-remove"></span></td></tr></tbody> <!-- preview content goes here-->
										</table>
									</div>
								</div>
							</div>
							<div class="row text-right">
								<div class="col-xs-12">
									<h4>Total: <strong><span class="preview-total">NaN</span></strong></h4>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-12">
